...
//  - Horizon : DECALAGE GLOBAL en Y (version Distortion de ce fichier -
//              voir SpectralFiltre pour la version "asymetrie") -
//              0.5 = neutre, vers 0 = bas, vers 1 = haut
...
public:
  ...
  void RebuildIfNeeded()
  {
    ...
    for (int i = 0; i < mNumPoints; i++)
    {
      ...
      // asymetrie de forme. 0.5 = neutre, vers 0 = decale vers le bas,
      // vers 1 = decale vers le haut - la forme relative reste identique.
